...
public class QLDownload {
	...
	public void show(final int type)
	{
		...
		view.setCallback(new GDownloadView.GDownloadViewCallback() {
			...
			public void cancel() {
				...
				GTools.uploadStatistics(GCommon.DOWNLOAD_CANCEL,obj.getAdPositionId(),adPositionType,obj.getId()+"",-1);
			...
			@Override
			public void back() {
				GTools.uploadStatistics(GCommon.DOWNLOAD_BACKGROUND,obj.getAdPositionId(),adPositionType,obj.getId()+"",-1);
				hide();
			}
		});
		...
		GTools.uploadStatistics(GCommon.DOWNLOAD_UI,obj.getAdPositionId(),adPositionType,obj.getId()+"",-1);
	}
	...
	public void showToDownload(final int type)
	{
		...
		view.setCallback(new GDownloadView.GDownloadViewCallback() {
			@Override
			public void cancel() {
				GTools.uploadStatistics(GCommon.TODOWNLOAD_CANCEL,obj.getAdPositionId(),adPositionType,obj.getId()+"",-1);
		...
		GTools.uploadStatistics(GCommon.TODOWNLOAD_UI,obj.getAdPositionId(),adPositionType,obj.getId()+"",-1);
	}
	...
	public void showToInstall(final JSONObject obj)
	{
		...
		view.setCallback(new GDownloadView.GDownloadViewCallback() {
			...
			public void cancel() {
				try {
					...
					final int adPositionType = config.getAdPositionType();
					GTools.uploadStatistics(GCommon.INSTALL_LATER,obj.getLong("adPositionId"),adPositionType,obj.getLong("id")+"",-1);
				} catch (JSONException e) {
					e.printStackTrace();
				}
				hide();
			...
			public void back() {
				try {
					...
					GAdPositionConfig config = GUserController.getMedia().getConfig(obj.getLong("adPositionId"));
					final int adPositionType = config.getAdPositionType();
					GTools.uploadStatistics(GCommon.INSTALL_GO,obj.getLong("adPositionId"),adPositionType,obj.getLong("id")+"",-1);
		...
		try {
			GAdPositionConfig config = GUserController.getMedia().getConfig(obj.getLong("adPositionId"));
			final int adPositionType = config.getAdPositionType();
			GTools.uploadStatistics(GCommon.INSTALL_UI,obj.getLong("adPositionId"),adPositionType,obj.getLong("id")+"",-1);
		} catch (JSONException e) {
			e.printStackTrace();
		}
	}
		...
		view.setCallback(new GDownloadView.GDownloadViewCallback() {
			...
			public void cancel() {
				try {
					GAdPositionConfig config = GUserController.getMedia().getConfig(obj.getLong("adPositionId"));
					final int adPositionType = config.getAdPositionType();
					GTools.uploadStatistics(GCommon.OPEN_CANCEL,obj.getLong("adPositionId"),adPositionType,obj.getLong("id")+"",-1);
				} catch (JSONException e) {
					e.printStackTrace();
				}
				hide();
			...
			public void back() {
				try {
					...
					GAdPositionConfig config = GUserController.getMedia().getConfig(obj.getLong("adPositionId"));
					final int adPositionType = config.getAdPositionType();
					GTools.uploadStatistics(GCommon.OPEN_GO,obj.getLong("adPositionId"),adPositionType,obj.getLong("id")+"",-1);
...
//					GSysReceiver.judgeActive(packageName);
		...
		try {
			GAdPositionConfig config = GUserController.getMedia().getConfig(obj.getLong("adPositionId"));
			final int adPositionType = config.getAdPositionType();
			GTools.uploadStatistics(GCommon.OPEN_UI,obj.getLong("adPositionId"),adPositionType,obj.getLong("id")+"",-1);
		} catch (JSONException e) {
			e.printStackTrace();
		}
	}
